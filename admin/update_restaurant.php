    ...
    <div id="main-wrapper">
        ...
        <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/YOHlogo.png"width=45 alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                                ...
                                <ul class="mega-dropdown-menu row">
                                    ...
                                    <li class="col-lg-3 col-xlg-3 m-b-30">
                                        ...
                                        <ul class="list-style-none">
                                            <li><a href="javascript:void(0)"><i class="fa fa-check text-success"></i> </a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
					...
					<footer class="footer"> Yoh! CT Streetfood Ordering System</footer>
                </div>
